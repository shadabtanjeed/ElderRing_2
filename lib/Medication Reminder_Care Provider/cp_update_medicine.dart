...
class CareProviderUpdateMedicine extends StatefulWidget {
  final String medicineId;
  final String username;
  final String elder_username;

  const CareProviderUpdateMedicine(
      {Key? key,
      required this.medicineId,
      required this.username,
      required this.elder_username})
      : super(key: key);

  @override
  State<CareProviderUpdateMedicine> createState() =>
      _CareProviderUpdateMedicineState();
}

class _CareProviderUpdateMedicineState
    extends State<CareProviderUpdateMedicine> {
  String username = '';
          ...
          Container(
            ...
            child: ListView(
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    await CareProviderUpdateMedicine(widget.medicineId);
                  },
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all(const Color(0xFF006769)),
  ...
  Future<void> CareProviderUpdateMedicine(String medicineId) async {
    setState(() {
      isLoading = true;
    });
